...
import { readGSheet } from '../googleSheet/readGSheet';
import { readNotionDatabase } from '../notion/readNotionDatabase';
...
async function main() {
    ...
    await readGSheet({logger})
    await readNotionDatabase({logger})
}
